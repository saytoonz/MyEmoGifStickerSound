...
public final class StickerFragment extends Fragment implements StickerAdapter.ItemSelectListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        File folder = new File(String.valueOf(getActivity().getExternalFilesDir("/stickers/")));
//        Create Directory if does not exist
        ...
        if (stickers.size() != 0) {
            ...
            mErrorTv.setText(getString(R.string.no_result_found));
            mViewFlipper.setDisplayedChild(1);
            Toast.makeText(mContext, "Download stickers from online..... stickers fragment", Toast.LENGTH_SHORT).show();
        }
    }
